...
import FranchiseApplicationVue from '@/view/FranchiseApplication.vue'
import FranchiseStatusVue from '@/view/FranchiseStatus.vue'
import FranchiseManagementVue from '@/view/FranchiseManagement.vue'
...
const routes = [
  ...
  //总部登录界面
  {path: '/headquarters-login', component:HeadquartersLoginVue },
  //总部仪表板
  {path: '/headquarters-dashboard', component:HeadquartersDashboardVue },
  //店长登录界面
  ...
  {path: '/Hr-overtime-working', component:HrOvertimeWorkingVue},
   ...
   //加盟申请
   { path: '/franchise-apply', component: FranchiseApplicationVue },
   //加盟申请状态查询
   { path: '/franchise-status', component: FranchiseStatusVue },
   //管理员加盟申请管理
   { path: '/franchise-management', component: FranchiseManagementVue },
   //管理员加盟店铺管理
