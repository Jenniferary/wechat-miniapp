<template>
  ...
  <ul class="menu-list">
    ...
    <li
      ...
      @click="selectSection('leave-progress', '/counter-leave-progress')"
    >
      我的请假记录
    </li>
  </ul>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchOrders() {
        try {
          const response = await axios.get("http://localhost:8080/api/order/get-all-orders/"+localStorage.getItem("branchId"));
