...
public class TakeawayController {
    ...
    INSERT INTO takeaway_orders (
        user_id, branch_id, delivery_address, dish_list, price, time_ordered,
...
""", userId, branchId, address, dishList, finalPrice, selectedCoupon, isCouponUsed ? 1 : 0, 0, estimatedTime, request.get("remark"));
